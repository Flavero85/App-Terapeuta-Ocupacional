...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // === LÓGICA DE TEMAS ===
    const themes = {
        'theme-teal': { name: 'Padrão', colors: { '--primary': '#14b8a6', '--primary-dark': '#0f766e', '--primary-light': '#ccfbf1', '--primary-text': '#0f766e', '--secondary-text': '#115e59', '--border-color': '#ccfbf1', '--primary-bg': '#f0fdfa', '--gradient-1': '#a7f3d0', '--gradient-2': '#bae6fd', '--gradient-3': '#ddd6fe', '--gradient-4': '#fbcfe8' }},
        'theme-sunset': { name: 'Pôr do Sol', colors: { '--primary': '#f97316', '--primary-dark': '#c2410c', '--primary-light': '#ffedd5', '--primary-text': '#b45309', '--secondary-text': '#92400e', '--border-color': '#fed7aa', '--primary-bg': '#fff7ed', '--gradient-1': '#ffedd5', '--gradient-2': '#fed7aa', '--gradient-3': '#fbcfe8', '--gradient-4': '#f5d0fe' }},
        'theme-ocean': { name: 'Oceano', colors: { '--primary': '#0ea5e9', '--primary-dark': '#0369a1', '--primary-light': '#e0f2fe', '--primary-text': '#0369a1', '--secondary-text': '#075985', '--border-color': '#e0f2fe', '--primary-bg': '#f0f9ff', '--gradient-1': '#67e8f9', '--gradient-2': '#7dd3fc', '--gradient-3': '#a5b4fc', '--gradient-4': '#c4b5fd' }},
        'theme-lavender': { name: 'Lavanda', colors: { '--primary': '#8b5cf6', '--primary-dark': '#6d28d9', '--primary-light': '#ede9fe', '--primary-text': '#6d28d9', '--secondary-text': '#5b21b6', '--border-color': '#ede9fe', '--primary-bg': '#f5f3ff', '--gradient-1': '#d8b4fe', '--gradient-2': '#c4b5fd', '--gradient-3': '#fbcfe8', '--gradient-4': '#fecdd3' }},
        'theme-forest': { name: 'Floresta', colors: { '--primary': '#16a34a', '--primary-dark': '#15803d', '--primary-light': '#dcfce7', '--primary-text': '#166534', '--secondary-text': '#14532d', '--border-color': '#bbf7d0', '--primary-bg': '#f0fdf4', '--gradient-1': '#bbf7d0', '--gradient-2': '#a3e635', '--gradient-3': '#fde047', '--gradient-4': '#fef3c7' }},
    };
    ...
    if (pageId === 'index-page') {
        ...
        if (themeSelector) {
            Object.keys(themes).forEach(themeKey => {
                ...
                dot.style.background = `linear-gradient(45deg, ${themes[themeKey].colors['--gradient-1']}, ${themes[themeKey].colors['--primary']})`;
